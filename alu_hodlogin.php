...
<table cellpadding="5px" cellspacing="5px">
<tr>
<td><a href="alu_hodlecture.php">view lecture request</a></td>
...
$a="select mobile_number from hodreg where mail_id='$mail'";
...
if($mob==$mob1)
{
echo"<script>alert('LOGIN SUCCESS FULLY'); location= 'alu_hod.php'</script>";
}
if($mob!=$mob1)
{
...
$a1="select user_id,name from hodreg where mail_id= '$mail'";
